...
function LoadingFallback() {
  return (
    <div class="flex h-[390px] items-start justify-start lg:h-auto">
      <div class="w-inherit relative h-full w-full max-w-sm overflow-hidden rounded-lg border bg-white p-4 lg:flex-nowrap">
        <div>
          <div class="mx-auto h-[150px] max-h-[300px] w-full max-w-[300px] rounded-md border-0 object-contain md:max-h-[300px] lg:h-[300px]" />
        </div>
        <div class="product-rating mb-2 mt-2 text-[12px] font-semibold uppercase invisible">
          brand
        </div>
        <div class="mb-3 h-[20px] truncate text-xs font-normal lg:text-[16px] invisible">
          name
        </div>
        <div class="inline-flex h-[25px] items-center gap-2 pb-0 pt-0 lg:gap-2 lg:pb-2 lg:pt-2">
          <div class="product-rating-count text-xs">
          </div>
        </div>
        <div class=" text-omantel-faded-black invisible flex items-center gap-2 text-[10px] font-normal lg:text-[14px] lg:font-medium">
          <div
            type="button"
            class="inline-flex items-center justify-center whitespace-nowrap font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-primary-foreground relative rounded-full text-[0] border product-colors h-1.5 w-1.5 p-0 lg:h-1.5 lg:w-1.5 border-bg-omantel-dark-green bg-omantel-dark-green hover:bg-omantel-dark-green"
            data-testid="colored-button"
          ...
          Stock<div class="text-[10px] font-normal text-omantel-alert-dark lg:text-xs">
            0
          </div>
        </div>
        <div class="py-0 text-xs text-omantel-secondary-blue lg:py-2 lg:text-sm invisible">
          <div class="rtl:inline-flex">
            <div class="omantel-secondary-blue omr-text text-xs rtl:order-2 lg:text-sm">
              OMR
            </div>{" "}
            <div class="omantel-secondary-blue new-price text-lg font-semibold lg:text-xl">
              0
            </div>
          </div>
        </div>
        <div class="text-[12px] text-gray-400 lg:text-sm invisible">
          Price inclusive of VAT
        </div>
        <div class="flex h-6 flex-row items-center justify-start gap-1 align-middle lg:gap-1">
          <div
